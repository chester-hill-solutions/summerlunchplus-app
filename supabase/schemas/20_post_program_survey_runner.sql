...
grant all on table public.post_program_survey_runner_lease to service_role;
grant all on table public.post_program_survey_runner_state to service_role;

create or replace function public.try_acquire_post_program_survey_runner_lease(
  p_job_key text,
  p_owner_run_id text,
  p_now timestamptz,
...
create or replace function public.release_post_program_survey_runner_lease(
  p_job_key text,
  p_owner_run_id text
)
returns boolean
