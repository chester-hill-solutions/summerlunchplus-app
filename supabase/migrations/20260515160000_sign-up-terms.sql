...
drop policy if exists sign_up_terms_read_active_public on public.sign_up_terms;
create policy sign_up_terms_read_active_public
  on public.sign_up_terms
  for select
  using (is_active = true);

drop policy if exists sign_up_terms_read_authorized on public.sign_up_terms;
create policy sign_up_terms_read_authorized
  on public.sign_up_terms
  for select
  using (public.authorize('form.read'));

drop policy if exists sign_up_terms_insert_authorized on public.sign_up_terms;
create policy sign_up_terms_insert_authorized
  on public.sign_up_terms
  for insert
  with check (public.authorize('form.update'));

drop policy if exists sign_up_terms_update_authorized on public.sign_up_terms;
...
drop policy if exists sign_up_terms_delete_authorized on public.sign_up_terms;
create policy sign_up_terms_delete_authorized
  on public.sign_up_terms
  for delete
  using (public.authorize('form.update'));

drop policy if exists sign_up_terms_read_auth_admin on public.sign_up_terms;
...
drop policy if exists sign_up_terms_insert_auth_admin on public.sign_up_terms;
...
drop policy if exists sign_up_terms_update_auth_admin on public.sign_up_terms;
...
drop policy if exists sign_up_terms_delete_auth_admin on public.sign_up_terms;
...
drop policy if exists sign_up_terms_consent_read_authorized on public.sign_up_terms_consent;
create policy sign_up_terms_consent_read_authorized
  on public.sign_up_terms_consent
  for select
  using (public.authorize('form.read'));

drop policy if exists sign_up_terms_consent_read_self on public.sign_up_terms_consent;
create policy sign_up_terms_consent_read_self
  on public.sign_up_terms_consent
  for select
  using (user_id = auth.uid());

drop policy if exists sign_up_terms_consent_insert_self on public.sign_up_terms_consent;
create policy sign_up_terms_consent_insert_self
  on public.sign_up_terms_consent
  for insert
  with check (user_id = auth.uid());

drop policy if exists sign_up_terms_consent_read_auth_admin on public.sign_up_terms_consent;
...
drop policy if exists sign_up_terms_consent_insert_auth_admin on public.sign_up_terms_consent;
