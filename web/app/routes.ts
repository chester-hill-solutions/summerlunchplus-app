...
export default [
  ...
  route("glr/:token", "routes/glr.$token.ts"),
  ...
  route("manage", "routes/manage/team.tsx", [
    ...
    route("class-attendance-mismatch", "routes/manage/class-attendance-mismatch.tsx"),
    ...
    route("zoom-job-attempt/table-data", "routes/manage/zoom-job-attempt.table-data.ts"),
    ...
    route("federal-electoral-district", "routes/manage/federal-electoral-district.tsx"),
      route("program-analytics", "routes/manage/program-analytics.tsx"),
      route("program-impact", "routes/manage/program-impact.tsx"),
