...
export const TABLE_DEFINITIONS: Record<string, TableDefinition> = {
  ...
  person: {
    label: 'Person',
    table: 'person',
    select: 'partner_program, role, email, firstname, surname, phone, postcode, password_set',
    columns: ['partner_program', 'role', 'email', 'firstname', 'surname', 'phone', 'postcode', 'password_set'],
    order: 'id',
  },
  'person-parent': {
