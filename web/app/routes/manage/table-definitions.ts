...
export const TABLE_DEFINITIONS: Record<string, TableDefinition> = {
  ...
  'class-attendance-audit': {
    label: 'Class Attendance Audit',
    table: 'class_attendance_audit',
    select:
      'id, class_attendance_id, class_id, profile_id, event_type, source, actor_user_id, actor_role, recorded_by_before, recorded_by_after, changed_fields, created_at',
    columns: [
      'class_attendance_id',
      'class_display',
      'profile_display',
      ...
      'actor_user_email',
      'actor_role',
      'recorded_by_before_email',
      'recorded_by_after_email',
      'created_at',
    ],
    order: 'created_at',
    orderAscending: false,
    lookupMappings: [
      ...
      {
        keyColumn: 'actor_user_id',
        table: 'profile',
        keyColumnInTable: 'user_id',
        select: 'user_id, email',
        valueColumn: 'email',
        resultColumn: 'actor_user_email',
      },
      {
        keyColumn: 'recorded_by_before',
        table: 'profile',
        keyColumnInTable: 'user_id',
        select: 'user_id, email',
        valueColumn: 'email',
        resultColumn: 'recorded_by_before_email',
      },
      {
        keyColumn: 'recorded_by_after',
        table: 'profile',
        keyColumnInTable: 'user_id',
        select: 'user_id, email',
        valueColumn: 'email',
        resultColumn: 'recorded_by_after_email',
      },
    ],
  },
  ...
  'zoom-job-run': {
    ...
    table: 'zoom_job_run',
    select:
      'id, run_id, trigger_source, trigger_kind, actor_user_id, actor_role, status, context, summary, error_message, started_at, completed_at, created_at, updated_at',
    columns: [
      'run_id',
      'trigger_source',
      'trigger_kind',
  ...
  'zoom-job-attempt': {
    ...
    table: 'zoom_job_attempt',
    select:
      'id, zoom_job_run_id, run_id, action_type, trigger_source, trigger_kind, status, class_id, profile_id, class_zoom_meeting_id, class_zoom_registrant_id, request_payload, result_payload, error_payload, external_request_payload, external_response_payload, error_message, started_at, completed_at, duration_ms, created_at, updated_at',
    columns: [
      'run_id',
      'action_type',
      'trigger_source',
