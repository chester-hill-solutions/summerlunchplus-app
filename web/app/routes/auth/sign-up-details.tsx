...
export const action = async ({ request }: ActionFunctionArgs) => {
  ...
  const { data: submission, error: submissionError } = await supabase
    ...
    .insert({
      ...
      ip_selected: requestMetadata.ipSelected,
      ip_selected_source: requestMetadata.ipSelectedSource,
      ip_chain: requestMetadata.ipChain,
      ip_parse_version: requestMetadata.ipParseVersion,
      ip_parse_confidence: requestMetadata.ipParseConfidence,
      ip_parse_notes: requestMetadata.ipParseNotes,
      ip_classification: requestMetadata.ipClassification,
      ip_confidence_level: requestMetadata.ipConfidenceLevel,
      ip_reason_codes: requestMetadata.ipReasonCodes,
      ip_reason_text: requestMetadata.ipReasonText,
      ip_classifier_version: requestMetadata.ipClassifierVersion,
      proxy_provider_match: requestMetadata.proxyProviderMatch,
      proxy_match_cidr: requestMetadata.proxyMatchCidr,
      ...
      request_headers: requestMetadata.requestHeaders,
      metadata,
    })
    .select('id')
    .single()
